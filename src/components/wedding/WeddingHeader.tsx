...
export default function WeddingHeader() {
  ...
  return (
    <>
      <div className="p-5 border border-gray-200 dark:border-gray-800 lg:p-6">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="w-100% h-20 overflow-hidden border border-gray-200 dark:border-gray-800 mb-10">
            <img src="/images/user/owner.jpg" alt="user" />
          </div>
          <ThemeToggleButton />
        </div>

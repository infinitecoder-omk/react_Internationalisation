    ...
    <>
      <div className="relative flex items-center justify-between w-full px-2 py-3 my-20">
        <div className="absolute left-1/2 transform -translate-x-1/2 text-lg font-semibold">
          ...
          {/* <div className="flex items-center text-center order-2 gap-2 grow xl:order-3 justify-center mt-3">
            <a
              href="https://www.facebook.com/PimjoHQ"
              target="_blank"
              rel="noopener"
              className="flex h-5 w-5 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200"
            >
              <svg
